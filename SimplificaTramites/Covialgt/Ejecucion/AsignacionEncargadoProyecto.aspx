<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionEncargadoProyecto.aspx.cs" Inherits="Covialgt.Ejecucion.AsignacionEncargadoProyecto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <h2 class="col-6 text-center">Encargado</h2>
    </div>
    <div class="row justify-content-between">
        ...
        <div class="form-group col-md-5 col-lg-5">
            <label for="encargadoInput">Encargado de Proyecto</label>
            <input type="text" class="form-control" id="encargadoInput" name="encargadoInput">
        </div>
    </div>
    <div class="row justify-content-between">
        <div class="form-group col-md-5 col-lg-5">
        ...
        <table class="table table-bordered table-hover mt-4" id="asignacion-table">
            <thead>
                <tr>
                    ...
                    <th class="text-center">Responsable Proyecto</th>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsAsignacionEncargadoProyecto.js?a=2") %>
</asp:Content>
