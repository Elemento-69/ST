<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionesRegionales.aspx.cs" Inherits="Covialgt.Ejecucion.AsignacionesRegionales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1>Asignar Regional</h1>
    <div class="row">
        <h2 class="col-6 text-center">Proyecto</h2>
        <h2 class="col-6 text-center">Regional</h2>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsAsignacionesRegionales.js?a=2") %>
</asp:Content>
