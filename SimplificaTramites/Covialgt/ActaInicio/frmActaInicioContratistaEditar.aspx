<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmActaInicioContratistaEditar.aspx.cs" Inherits="Covialgt.ActaInicio.frmActaInicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>EDITAR ACTA DE INICIO CONTRATISTA</h1>
    ...
    <div class="card-body" >
        ...
        <div class="form-group col-md-5 col-lg-5">
            ...
            <input type="text" id="codigoacta" name="codigoacta" class="btn btn-primary px-5 btn-sm" style="display:none">
    ...
    <div class="row justify-content-between">
        ...
        <div class="form-row">
            <input type="text" class="form-control" id="proyectocodigo" style="display:none">
            <div class="col-md-4 mb-3">
          <label for="empresaProyecto">Empresa Proyecto</label>
          <input type="text" class="form-control" id="empresaProyecto" placeholder="Empresa" required>
      </div>
        </div>
        <div class="form-row">
      <div class="col-md-4 mb-3">
          <label for="validationServer01">Superintendente</label>
          <input type="text" class="form-control" id="superintendente" placeholder="Superintendente" required>
      </div>
    ...
    <div class="card-body" >
     ...
     <div class="form-row">
      ...
      <div class="form-group col-md-5 col-lg-5">
            ...
            <option value="2">Representante (a)</option>
            <option value="2">Mandatario (a)</option>
            </select>
        </div>
        </div>
    </div>
  ...
  <div id="card-datos-acta" class="card custom-card" style="margin-left: 10px; margin-top: 10px;  margin-right: 30px; margin-bottom: 10px;" >  
       ...
       <div class="col-md-2 mb-3">
         ...
         <div class="row">
          ...
          <input type="text" class="form-control" id="clausula" placeholder="CUARTA" required>
             ...
             <div class="col-md-4 mb-3">
          <label for="cedulaNotificacion">Cédula de notificación</label>
          <input type="text" class="form-control" id="cedulaNotificacion" placeholder="217788" required>
      </div>
             <div class="col-md-4 mb-3">
    ...
    <div class="row">
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalVistaPreviaEditar" id="btnVistaPreviaEditar">
  VISTA PREVIA EDITADA
</button>
 <div class="modal fade" id="ModalVistaPreviaEditar" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitleEditar" aria-hidden="true">
  <div class="modal-dialog  modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">EDITADA VISTA PREVIA</h5>
      ...
      <div class="modal-body">
         <div class="col-xl-12">
                           <!--<textarea class="form-control" id="DescripcionBitacoraComentar" rows="5" disabled></textarea>-->
                            <iframe name="TextoVistaPreviaEditar" id="TextoVistaPreviaEditar" style="width: 1075px; height:700px;">
                            </iframe>
                        </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">REGRESAR</button>
        <button type="button" id="btnIngresarActaEditada" class="btn btn-primary">GENERAR ACTA EDITADA</button>
      </div>
    </div>
  </div>
</div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/ActaInicio/jsActaInicioContratistaEditar.js") %>
    <style>
        body {
