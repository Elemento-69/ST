<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InformeContratadoSaldoPresupuesto.aspx.cs" Inherits="Covialgt.Informes.InformeContratadoSaldoPresupuesto" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsInformeContratadoSaldoPresupuesto.js?a=2") %>
