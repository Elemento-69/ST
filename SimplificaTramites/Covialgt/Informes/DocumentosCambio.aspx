<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentosCambio.aspx.cs" Inherits="Covialgt.Informes.DocumentosCambio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<h1>Reporte de Documentos de Cambio</h1>
    ...
    <div class="row">
        <div class="form-group col-md-5 col-lg-3">
            <div class="form-group">
                <label for="desdeInput">Fecha Inicio</label>
        ...
        <div class="form-group col-md-5 col-lg-3">
            <label for="hastaInput">Fecha Fin</label>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <div class="custom-radio pading-radio-todos px-0 pl-4">
                                        <input type="radio" class="custom-control-input" id="customRadioIngresosEgresos" name="mensuales"
                                            value="resumen" checked>
                                        <label class="custom-control-label" for="customRadioIngresosEgresos">Documentos de Cambio Resumen</label>
                                    </div>
                                </div>
                                <div class="col-lg-12 mb-3">
                                    <div class="custom-radio px-0 pl-4">
                                        <input type="radio" class="custom-control-input" id="customRadioEstimacionesVisor" name="mensuales"
                                            value="detalle">
                                        <label class="custom-control-label" for="customRadioEstimacionesVisor">Documentos de Cambio Detalle</label>
                                    </div>
                                </div>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsDocCambio.js") %>
