<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InformeCongreso.aspx.cs" Inherits="Covialgt.Informes.InformeCongreso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>INFORME CONGRESO DE LA REPÚBLICA - COMISIÓN DE TRANSPARENCIA</h1>
    <hr class="thick" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsReporteInformeCongreso.js?a=3") %>
