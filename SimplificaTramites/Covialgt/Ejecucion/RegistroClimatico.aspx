<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistroClimatico.aspx.cs" Inherits="Covialgt.Ejecucion.RegistroClimatico" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CustomStyles" runat="server">
     <%: Styles.Render("~/Content/ejecucion.css") %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsRegistroClimatico.js") %>
</asp:Content>
