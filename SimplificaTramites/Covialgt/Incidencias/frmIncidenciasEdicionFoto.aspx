<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmIncidenciasEdicionFoto.aspx.cs" Inherits="Covialgt.Incidencias.frmIncidenciasEdicionFoto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script src="../js/jsIncidenciasPantallaEdicionFoto.js"></script>
    <script src="../js/jsIncidenciasPantallaEdicionFotoToken.js"></script>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">       
    <script src="../js/jsIncidenciasPantallaEdicionFoto_ZoomFoto.js"></script>
