<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DocumentosDeCambioConsulta.aspx.cs" Inherits="Covialgt.Ejecucion.DocumentosDeCambioConsulta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr class="thick" />
    <h4 class="mt-5">Consulta de Documentos de Cambio</h4>
    <div class="row mt-5">
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsDocumentosCambioConsulta.js") %>
</asp:Content>
