...
namespace SimplificaTramites.Incidencias
{
    public partial class frmIncidenciasEdicionFoto : System.Web.UI.Page
    {
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static int fRotarFoto(long idIncidencia, string nombreArchivo, bool rotarIzquierda)
        {
            string rutaCarpeta = ConfigurationManager.AppSettings["Incidencias"] + "Multimedia\\Fotos\\ID_" + idIncidencia + "\\";
            ...
            fReemplazarArchivoFoto(idIncidencia, nombreArchivo, a + "." + extension);
        ...
        [WebMethod]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static Boolean fReemplazarArchivoFoto(long idIncidencia, string archivoOriginal, string archivoTemporal)
        {
            string rutaCarpeta = ConfigurationManager.AppSettings["Incidencias"] + "Multimedia\\Fotos\\ID_" + idIncidencia + "\\";
            try
            {
