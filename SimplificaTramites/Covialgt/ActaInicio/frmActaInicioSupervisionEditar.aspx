<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmActaInicioSupervisionEditar.aspx.cs" Inherits="Covialgt.ActaInicio.frmActaInicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>EDITAR ACTA DE INICIO SUPERVISION</h1>
  ...
  <div class="modal-dialog  modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">VISTA PREVIA EDITADA</h5>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnIngresarActaSuperEditada" class="btn btn-primary">GENERAR ACTA EDITADA</button>
      </div>
    </div>
  </div>
</div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/ActaInicio/jsActaInicioSupervisionEditar.js") %>
    <style>
        body {
