...
function fnMostrarRegistro() {
    const url = baseHostURL + "api/EmergenciasApp/obtenerDatosDeVideo/" + vIdEmergencia + "/" + vIdArchivoMultimedia;
...
function fnGrabarThumbnail() {
    var urlMetodo = baseHostURL + "api/EmergenciasApp/actualizarThumbnailDeVideo";
    ...
    fetch(urlMetodo, {
        ...
        .then(data => {
            ...
            if (urlArchivoThumbnail.length > 0) {
                ...
                document.getElementById("imageThumbnail").src = thumbnail + "Tipo=7 & MaxPixels=0 & Fotografia=" + urlArchivoThumbnail;
            }
        })
        .catch(function (error) {
            $.LoadingOverlay("hide");
