<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmEstimacionesEstructuraTramos.aspx.cs" Inherits="Covialgt.Estimaciones.frmEstimacionesEstructuraTramos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h1 class="mb-0">Estructura de Estimaciones Tramos</h1>
    <hr class="thick" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%--Archivos Js --%>
    <%: Scripts.Render("~/js/jsEstimacionesEstructuraTramos.js") %>  
</asp:Content>
