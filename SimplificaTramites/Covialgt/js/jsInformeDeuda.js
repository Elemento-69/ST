$(document).ready(function () {
    ...
    $("#btnGenerar").click(function () {
        let anterior = moment($('#anteriorInput').val(), "DD-MM-YYYY").isValid() ? $("#anterior-dp").datetimepicker("date").format("YYYY,MM,DD") : ''
        let actual = moment($('#actualInput').val(), "DD-MM-YYYY").isValid() ? $("#actual-dp").datetimepicker("date").format("YYYY,MM,DD") : ''
        ...
        opendialog(`/VisorInformes.aspx?Parameters=${anterior},${actual}&IdReporte=58`)
    })
})
