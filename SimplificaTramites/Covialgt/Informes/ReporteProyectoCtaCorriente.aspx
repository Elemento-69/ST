<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteProyectoCtaCorriente.aspx.cs" Inherits="Covialgt.Informes.ReporteProyectoCtaCorriente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>Informe: Cuenta corriente por proyecto.</h1>
    <hr class="thick" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <script>
        ...
        tipoReporte = "<%= ViewState["tipoReporte"] ?? "null" %>"
        token = "<%= Session["token"] ?? "null" %>"
        usuario = "<%= Session["usuario"] %>"
        rol = "<%= Session["rol"] %>"
    </script>
    <%: Scripts.Render("~/js/jsReporteProyectoCtaCorriente.js?a=3") %>
