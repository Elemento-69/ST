<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Sancionesxanio.aspx.cs" Inherits="Covialgt.Sanciones.Sancionesxanio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	<h1>Sanciones por A&ntilde;o</h1>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsSancionesxanio.js?a=1") %>
