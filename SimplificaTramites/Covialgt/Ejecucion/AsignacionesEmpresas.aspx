<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AsignacionesEmpresas.aspx.cs" Inherits="Covialgt.Ejecucion.AsignacionesEmpresas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
   <script src="https://code.jquery.com/jquery-1.12.4.js"></script>
    ...
    <div class="row">
        ...
        <h2 class="col-6 text-center">Empresas</h2>
    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/jsAsignacionesEmpresas.js") %>
</asp:Content>
