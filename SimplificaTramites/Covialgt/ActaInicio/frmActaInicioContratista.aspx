<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmActaInicioContratista.aspx.cs" Inherits="Covialgt.ActaInicio.frmActaInicio" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>ACTA DE INICIO CONTRATISTA</h1>
    ...
    <div class="card-body" >
        ...
        <div class="form-group col-md-5 col-lg-5">
            ...
            <input type="text" class="form-control" id="anioSelect">
        </div>
        <div class="form-group col-md-5 col-lg-5">
  ...
  <div class="modal-dialog  modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="btnIngresarActa" class="btn btn-primary">GENERAR ACTA</button>
      </div>
    </div>
  </div>
</div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="CustomScripts" runat="server">
    ...
    <%: Scripts.Render("~/js/ActaInicio/jsActaInicioContratista.js") %>
    <style>
        body {
