...
namespace Covialgt.Reportes
{
    public class Catalogos
    {
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static DataSet ObtenerTodos(string Procedimiento) => Covialgt.Reportes.DALSICOP.Catalogos.ObtenerTodos(Procedimiento);
        ...
        public static int Operacion(string Usuario, DataTable tabla, params string[] Procedimientos)
        {
            ...
            try
            {
                foreach (DataRow row in tabla.Rows)
                {
                    ...
                    if (Covialgt.Reportes.DALSICOP.Catalogos.Operacion(Procedimientos[(int)tipoOperacion], objectList.ToArray()) == 0)
                        checked { ++num2; }
                    continue;
                }
            }
          ...
          params string[] Procedimientos)
        {
            ...
            try
            {
                foreach (DataRow row in tabla.Rows)
                {
                    ...
                    if (Covialgt.Reportes.DALSICOP.Catalogos.Operacion(Transaccion, Procedimientos[(int)tipoOperacion], objectList.ToArray()) == 0)
                        checked { ++num2; }
                     continue;
                }
            }
        ...
        /// <returns></returns>
        /// <remarks></remarks>
        public static int Operacion(string Procedimiento, params object[] Datos) => Covialgt.Reportes.DALSICOP.Catalogos.Operacion(Procedimiento, Datos);
